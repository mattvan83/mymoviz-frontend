...
function Home() {
  ...
  // Use useEffect to fetch the backend route questioning the TMDB API and attribute the result to moviesData state
  useEffect(() => {
    fetch("https://mymoviz-backend-five-iota.vercel.app/movies")
